...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if(empty($username)){
        ...
        $stmnt = $conn->prepare("SELECT * FROM admin WHERE username = :username and password = :password");
        ...
        if ($count > 0) {
          ...
          $SuccessMsg = "Success You Will Be Redirected To The Page In 3 Seconds :)";

        } else{

          $ErrorMsg[] = "Sorry You Not Admin :(";
